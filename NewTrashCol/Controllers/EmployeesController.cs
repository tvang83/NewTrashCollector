...
namespace NewTrashCol.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,ZipCode,IdentityUserId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,ZipCode,IdentityUserId")] Employee employee)
        {
            if (id != employee.Name)
            {
                return NotFound();
